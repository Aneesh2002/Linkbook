...
import { addContact } from '../service/api'; // Import the API function
...
export default function Add({ navigation }) {
  ...
  const handleSubmit = async () => {
    ...
    if (success) {
      ...
      navigation.navigate("Home"); // Redirect to Home after adding contact
    } else {
      Alert.alert("Error", "Failed to add contact. Try again!");
    }
  };
